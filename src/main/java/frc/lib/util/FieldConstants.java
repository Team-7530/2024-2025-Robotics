...
public final class FieldConstants {
    ...
    public static class Reef {
        ...
        public static class StagingPositions {
            public static final Pose2d leftStaging = new Pose2d(Units.inchesToMeters(48), Units.inchesToMeters(230.5), new Rotation2d());
            public static final Pose2d middleStaging = new Pose2d(Units.inchesToMeters(48), Units.inchesToMeters(158.5), new Rotation2d());
            public static final Pose2d rightStaging = new Pose2d(Units.inchesToMeters(48), Units.inchesToMeters(86.5), new Rotation2d());
        }
