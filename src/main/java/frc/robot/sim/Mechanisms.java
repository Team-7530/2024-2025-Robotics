...
public class Mechanisms {
  ...
  MechanismLigament2d rotorArm = mech.
                                getRoot("rotorArmPivotPoint", 0.5, 0.2).
                                append(new MechanismLigament2d("rotorArm", .04, 0, 0, new Color8Bit(Color.kAliceBlue)));

  MechanismLigament2d rotorArmSide1 = rotorArm.append(new MechanismLigament2d("rotorArmSide1", 0.038267, 120, 6, new Color8Bit(Color.kAliceBlue)));
  MechanismLigament2d rotorArmSide2 = rotorArmSide1.append(new MechanismLigament2d("rotorArmSide2", 0.038267, 60, 6, new Color8Bit(Color.kAliceBlue)));
  MechanismLigament2d rotorArmSide3 = rotorArmSide2.append(new MechanismLigament2d("rotorArmSide3", 0.038267, 60, 6, new Color8Bit(Color.kAliceBlue)));
  MechanismLigament2d rotorArmSide4 = rotorArmSide3.append(new MechanismLigament2d("rotorArmSide4", 0.038267, 60, 6, new Color8Bit(Color.kAliceBlue)));
  MechanismLigament2d rotorArmSide5 = rotorArmSide4.append(new MechanismLigament2d("rotorArmSide5", 0.038267, 60, 6, new Color8Bit(Color.kAliceBlue)));
  MechanismLigament2d rotorArmSide6 = rotorArmSide5.append(new MechanismLigament2d("rotorArmSide6", 0.038267, 60, 6, new Color8Bit(Color.kAliceBlue)));

  /* Arm ligaments */
  MechanismLigament2d ccArm = mech.
                                getRoot("armPivotPoint", 0.5, 0.2).
  ...
  MechanismLigament2d rotorClimb = mech.
                                getRoot("rotorClimberPivotPoint", 0.75, 0.3).
                                append(new MechanismLigament2d("rotorClimb", .04, 0, 0, new Color8Bit(Color.kAliceBlue)));

  MechanismLigament2d rotorClimbSide1 = rotorClimb.append(new MechanismLigament2d("rotorClimbSide1", 0.038267, 120, 6, new Color8Bit(Color.kAliceBlue)));
  MechanismLigament2d rotorClimbSide2 = rotorClimbSide1.append(new MechanismLigament2d("rotorClimbSide2", 0.038267, 60, 6, new Color8Bit(Color.kAliceBlue)));
  MechanismLigament2d rotorClimbSide3 = rotorClimbSide2.append(new MechanismLigament2d("rotorClimbSide3", 0.038267, 60, 6, new Color8Bit(Color.kAliceBlue)));
  MechanismLigament2d rotorClimbSide4 = rotorClimbSide3.append(new MechanismLigament2d("rotorClimbSide4", 0.038267, 60, 6, new Color8Bit(Color.kAliceBlue)));
  MechanismLigament2d rotorClimbSide5 = rotorClimbSide4.append(new MechanismLigament2d("rotorClimbSide5", 0.038267, 60, 6, new Color8Bit(Color.kAliceBlue)));
  MechanismLigament2d rotorClimbSide6 = rotorClimbSide5.append(new MechanismLigament2d("rotorClimbSide6", 0.038267, 60, 6, new Color8Bit(Color.kAliceBlue)));


  MechanismLigament2d ccClimb = mech.
                                getRoot("climbPivotPoint", 0.75, 0.3).
                                append(new MechanismLigament2d("ccClimb", .15, 90, 6, new Color8Bit(Color.kPurple)));
  MechanismLigament2d climbSide1 = ccClimb.append(new MechanismLigament2d("climbSide1", .1, -90, 6, new Color8Bit(Color.kPurple)));
  MechanismLigament2d climbSide2 = ccClimb.append(new MechanismLigament2d("climbSide2", 0.25, 180, 6, new Color8Bit(Color.kPurple)));


  public void update(double armRotorPos, double armEncoderPos, double wristEncoderPos, double climbRotorPos, double climbEncoderPos) {
